...
//polygon(15% 0%, 100% 0%, 100% 100%, 0% 100%, 0% 15%)
  ...
  const drawNavDots = (cardCount, cardIndex) => {
   ...
   let dotRGB = currentCard.classList.contains("dots-light") ? {red: 255, green: 255, blue: 255} : {red: 0, green: 0, blue: 0};
  ...
  function disableForm() {
      ...
      theForm.querySelectorAll("button").forEach(function(item) {item.style.display = 'none'});
  }
