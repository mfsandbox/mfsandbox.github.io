...
const submitJoinForm = function () {
    const selectedKeyword = (document.querySelector('input[name="subscriberKeyword"]:checked') || {value: ''}).value;
    if (selectedKeyword === "") {
    ...
    document.querySelectorAll('input[name="subscriberKeyword"]').forEach(function (item) {
        item.disabled = true;
    });
