...
if (cardCount > 1) {
    ...
    document.querySelectorAll(".deck .cardIndexDecrementor").forEach(
        (decrementor) => {
            decrementor.addEventListener('click', function (event) {
                decrementCardIndex();
                setCardVisibility(cards, navIcons);
            })
        }
    ...
    document.querySelectorAll(".deck .cardIndexIncrementor").forEach(
        (incrementor) => {
            incrementor.addEventListener('click', function (event) {
                incrementCardIndex();
                setCardVisibility(cards, navIcons);
            })
        }
